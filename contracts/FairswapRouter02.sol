...
import './interfaces/IFairswapRouter02.sol';
...
contract FairswapRouter02 is IFairswapRouter02 {
    ...
    function _swapSupportingFeeOnTransferTokens(address[] memory path, address _to) internal virtual {
        for (uint i; i < path.length - 1; i++) {
            ...
            amountOutput = FairswapLibrary.getAmountOut(factory, amountInput, reserveInput, reserveOutput);
            }
    ...
    {
        return FairswapLibrary.getAmountIn(factory, amountOut, reserveIn, reserveOut);
    }
